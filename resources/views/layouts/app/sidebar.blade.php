        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group expandable :expanded="false" :heading="__('Contracts')" class="grid">
                    ...
                    <flux:sidebar.item icon="document-text" class="cursor-pointer" :href="route('contracts.expired')" :current="request()->routeIs('contract.expired')" wire:navigate>
                ...
                @if (auth()->user()->user_type == 'Admin')
                    ...
                    <flux:sidebar.group :heading="__('')" class="grid">
                        <flux:sidebar.item icon="building-library" :href="route('procurement.index')" class="cursor-pointer" :current="request()->routeIs('procurement.index')" wire:navigate>
                            {{ __('Procurement Mode') }}
                        </flux:sidebar.item>
                    </flux:sidebar.group>
